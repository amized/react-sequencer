(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("react-sequencer", [], factory);
	else if(typeof exports === 'object')
		exports["react-sequencer"] = factory();
	else
		root["react-sequencer"] = factory();
})(window, function() {
...
function () {
  function Sequencer(props) {
    ...
    _defineProperty(this, "onLoop", function () {
      if (_this.status !== STATUS_PLAYING) {
        return;
      }
      ...
      var completesAt = currentStep.position;
      ...
      _this.requestID = window.requestAnimationFrame(_this.onLoop);
    });
    ...
    _defineProperty(this, "isComplete", function () {
      return _this.status === STATUS_COMPLETE;
    });

    _defineProperty(this, "isPlaying", function () {
      return _this.status === STATUS_PLAYING;
    });
  ...
  _createClass(Sequencer, [{
    key: "generateSteps",
    value: function generateSteps(stepsInput) {
      if (!stepsInput || _typeof(stepsInput) !== 'object') {
        return null;
      }

      var prev = 0;
      var steps = stepsInput.map(function (step) {
        var position = step[1] + prev;
        prev = position;
        return {
          position: position,
          name: step[0]
...
function (_React$PureComponent) {
  ...
  function Transition(props) {
    ...
    _defineProperty(_this, "handleInSeqChange", function (seq) {
      _this.setState({
        current: seq.current,
        exitComplete: false
      });
    ...
    _defineProperty(_this, "handleOutSeqChange", function (seq) {
      _this.setState({
        current: seq.current,
    ...
    var state = {
      current: props.in && props.runOnMount || !props.in ? _this.inSeq.getState().current : _this.outSeq.getState().current,
  ...
  return function (Component) {
    return (
      ...
      function (_React$PureComponent) {
        ...
        function SequencerWrapper(_props) {
          var _this;

          _classCallCheck(this, SequencerWrapper);

          _this = _possibleConstructorReturn(this, (SequencerWrapper.__proto__ || Object.getPrototypeOf(SequencerWrapper)).call(this, _props));

          _defineProperty(_this, "handleChange", function (props) {
            _this.setState(props);
          });

          _this.sequencer = new _sequencer.default({
            steps: steps,
            loop: loop
          });
